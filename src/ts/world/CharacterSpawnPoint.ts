  ...
  public spawn(
    ...
    loadingManager
      ...
      .then((model) => {
        ...
        console.log(
          "CharacterSpawnPoint: Player position before raycast:",
          worldPos.x,
          worldPos.y,
          worldPos.z
        );
        ...
        if (
          ...
          if (raycastResult.hasHit) {
            ...
            console.log(
              "CharacterSpawnPoint: Raycast hit:",
        ...
        console.log(
          "CharacterSpawnPoint: Player position after raycast:",
          worldPos.x,
          worldPos.y,
          worldPos.z
        );
        ...
        console.log(
          "CharacterSpawnPoint: Adding player to world and taking control."
        );
