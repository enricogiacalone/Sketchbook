...
export class Airplane extends Vehicle implements IControllable, IWorldEntity {
    ...
    constructor(gltf: any) {
        ...
        this.physicsPreStep = this.physicsPreStepAirplane;
    ...
    public physicsPreStepAirplane(body: CANNON.Body): void {
        ...
        rotStabInfluence *=
            this.rayCastVehicle.numWheelsOnGround > 0 && currentSpeed < 0
                ? 0
                : 1; // Reverse fix
        let loopFix =
            this.actions.throttle.isPressed && currentSpeed > 0 ? 0 : 1;
        ...
        if (this.actions.throttle.isPressed && !this.actions.brake.isPressed) {
            speedModifier = 0.06;
        } else if (
            !this.actions.throttle.isPressed &&
            this.actions.brake.isPressed
