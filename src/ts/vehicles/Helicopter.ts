...
export class Helicopter extends Vehicle implements IControllable, IWorldEntity {
    ...
    constructor(gltf: any) {
        ...
        this.physicsPreStep = this.physicsPreStepHeli;
    ...
    public physicsPreStepHeli(body: CANNON.Body): void {
        ...
        let vertDamping = new THREE.Vector3(
            0,
            body.velocity.y,
            0
        ).multiplyScalar(-0.01);
        ...
        if (this.controllingCharacter !== undefined) {
            ...
            let rotStabEuler = new THREE.Euler().setFromQuaternion(
                rotStabVelocity
            );
